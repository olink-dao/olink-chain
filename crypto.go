...
// CreateAddress creates an olink address given the bytes and the nonce
func CreateAddress(b common.Address, nonce uint64) common.Address {
	data, _ := rlp.EncodeToBytes([]interface{}{b, nonce})
	return common.BytesToAddress(Keccak256(data)[12:])
}

// CreateAddress2 creates an olink address given the address bytes, initial
...
func PubkeyToAddress(p ecdsa.PublicKey) common.Address {
	...
	//pubBytes := FromECDSAPubCompressed(&p)
	//return common.BytesToAddress(Ripemd160Hash(Sha256Hash(pubBytes)))
	return common.BytesToAddress(Ripemd160Hash(Sha256Hash(PubkeyCompress(pubBytes))))
}
...
func Ripemd160Hash(bytes []byte) []byte {
...
func PubkeyCompress(s []byte) []byte {
